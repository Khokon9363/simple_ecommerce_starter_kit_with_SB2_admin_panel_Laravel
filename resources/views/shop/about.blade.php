	    ...
	    <div class="container">
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
				   	<img src="{{ asset('shop/images/ab_pic.jpg') }}" alt=" " class="img-responsive" />
				</div>
			...
			<div class="inner_w3l_agile_grids">
					<div class="col-md-3 team-grids">
						<div class="thumbnail team-w3agile">
							<img src="{{ asset('shop/images/t1.jpg') }}" class="img-responsive" alt="">
						...
						<div class="col-md-3 team-grids">
						<div class="thumbnail team-w3agile">
							<img src="{{ asset('shop/images/t2.jpg') }}" class="img-responsive" alt="">
							<div class="social-icons team-icons right-w3l fotw33">
							<div class="caption">
								<h4>Anika Mollik</h4>
								<p>Add Short Description</p>						
						...
						<div class="col-md-3 team-grids">
						<div class="thumbnail team-w3agile">
							<img src="{{ asset('shop/images/t3.jpg') }}" class="img-responsive" alt="">
							<div class="social-icons team-icons right-w3l fotw33">
							<div class="caption">
								<h4>Megali Deo</h4>
								<p>Add Short Description</p>						
						...
						<div class="col-md-3 team-grids">
						<div class="thumbnail team-w3agile">
							<img src="{{ asset('shop/images/t4.jpg') }}" class="img-responsive" alt="">
							<div class="social-icons team-icons right-w3l fotw33">
							<div class="caption">
								<h4>Retas Word</h4>
								<p>Add Short Description</p>						
